 ...
 * Generated at: 2017-01-20 09:51:27 UTC
...
return;
    ...
    try {
      ...
      out.write("                <a href=\"dashboard\"><span class=\"fa fa-desktop\"></span> <span class=\"xn-text\">Dashboard</span></a>\n");
      out.write("\n");
      out.write("            <li><a href=\"graph_visualizer\"><span class=\"fa fa-users\"></span> Shapelet Visualizer</a></li>\n");
      out.write("\n");
      out.write("        </ul>\n");
      ...
      out.write("                        <a>Show all messages</a>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </li>\n");
      ...
      out.write("                            <div class=\"widget-int num-count\">2</div>\n");
      out.write("                            <div class=\"widget-title\">Events</div>\n");
      out.write("                            <div class=\"widget-subtitle\">In your Dataset</div>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"widget-controls\">\n");
      out.write("                            <a href=\"#\" class=\"widget-control-right widget-remove\" data-toggle=\"tooltip\"\n");
      out.write("                               data-placement=\"top\" title=\"Remove Widget\"><span class=\"fa fa-times\"></span></a>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      ...
      out.write("                        </div>\n");
      out.write("                        <div class=\"widget-data\">\n");
      out.write("                            <div class=\"widget-int num-count\">4234521</div>\n");
      out.write("                            <div class=\"widget-title\">Shapelets</div>\n");
      out.write("                            <div class=\"widget-subtitle\">In your Dataset</div>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"widget-controls\">\n");
      out.write("                            <a href=\"#\" class=\"widget-control-right widget-remove\" data-toggle=\"tooltip\"\n");
      ...
      out.write("                    <div class=\"widget widget-default widget-item-icon\" onclick=\"location.href='graph_visualizer';\">\n");
      out.write("                        <div class=\"widget-item-left\">\n");
      out.write("                            <span class=\"fa fa-user\"></span>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"widget-data\">\n");
      out.write("                            <div class=\"widget-int num-count\">375</div>\n");
      out.write("                            <div class=\"widget-title\">Important Shapelets</div>\n");
      out.write("                            <div class=\"widget-subtitle\">In your Dataset</div>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"widget-controls\">\n");
      out.write("                            <a href=\"#\" class=\"widget-control-right widget-remove\" data-toggle=\"tooltip\"\n");
      ...
      out.write("                    <div class=\"widget widget-info widget-padding-sm\">\n");
      out.write("                        <div class=\"widget-big-int plugin-clock\">00:00</div>\n");
      out.write("                        <div class=\"widget-subtitle plugin-date\">Loading...</div>\n");
      out.write("                        <div class=\"widget-controls\">\n");
      out.write("                            <a href=\"#\" class=\"widget-control-right widget-remove\" data-toggle=\"tooltip\"\n");
      out.write("                               data-placement=\"left\" title=\"Remove Widget\"><span class=\"fa fa-times\"></span></a>\n");
      out.write("                        </div>\n");
      ...
      out.write("                    <div class=\"panel-heading\"><strong>Upload Files</strong>\n");
      out.write("                        <small>File upload</small>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"panel-body\">\n");
      out.write("\n");
      out.write("                        <!-- Standar Form -->\n");
      out.write("                        <h4>Select files from your computer</h4>\n");
      out.write("                        <form action=\"uploadFile\" method=\"POST\" enctype=\"multipart/form-data\" id=\"submitForm\"\n");
      out.write("                              enctype=\"multipart/form-data\">\n");
      out.write("                            <div class=\"form-inline\">\n");
      out.write("                                <div class=\"form-group\">\n");
      out.write("                                    <input type=\"file\" name=\"file\" id=\"js-upload-files\" multiple>\n");
      out.write("                                </div>\n");
      out.write("                                <button type=\"submit\" class=\"btn btn-sm btn-primary\" onclick=\"uploadJqueryForm()\"\n");
      out.write("                                        id=\"js-upload-submit\">Upload file\n");
      out.write("                                </button>\n");
      out.write("                            </div>\n");
      out.write("                        </form>\n");
      out.write("                        <div id=\"result\"></div>\n");
      out.write("                        <div id=\"loading\">\n");
      out.write("                            <p><img src=\"../../resources/img/jquery/loading-overlay.gif\"/>\n");
      out.write("                            </p>\n");
      out.write("                        </div>\n");
      out.write("                        <!-- Drop Zone -->\n");
      ...
      out.write("                            <h3>Select Previous Uploaded Files</h3>\n");
      out.write("\n");
      out.write("                        </div>\n");
      out.write("                        <div>\n");
      out.write("                            <select onchange=\"selectDatabase()\" id=\"myselect\" name=\"myselect\"></select>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"js-upload-finished\">\n");
      out.write("                            <h3></h3>\n");
      ...
      out.write("                        </div>\n");
      out.write("                        <div>\n");
      out.write("                          <form method=\"GET\" action=\"/redirect\">\n");
      out.write("                            <button type=\"submit\" class=\"btn btn-sm btn-primary\" id=\"js-upload-submited\"> Proceed\n");
      out.write("\n");
      out.write("                            </button>\n");
      out.write("                            </form>\n");
      out.write("                        </div>\n");
      ...
      out.write("<script src=\"../../resources/js/plugins/jquery/jquery.form.js\"></script>\n");
      out.write("<script src=\"../../resources/js/custom.js\"></script>\n");
      out.write("\n");
      out.write("<script>\n");
      out.write("    $(document).ready(function () {\n");
      out.write("        $('#loading').hide();\n");
      out.write("        $.getJSON(\"/datasets\", function (json) {\n");
      out.write("            $('#myselect').empty();\n");
      out.write("            $.each(json.Files, function (i, obj) {\n");
      out.write("                $('#myselect').append($('<option>').text(obj.File_Name).attr('value', obj.val));\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("    });\n");
      out.write("</script>\n");
